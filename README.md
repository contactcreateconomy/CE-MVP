...
**Status:** Phases 1–7 complete (MVP code-complete 2026-09-10; 902/902 tests; 2026-09-12 audit reconciled doc drift). The backend is deployed and seeded on the shared Convex dev deployment (`watchful-chameleon-570`) — see [Before development starts](#before-development-starts) for what remains.
...
# demo content seeds via seed:bootstrap at deploy (the seed-forum script was removed in P7-CLEANUP)
...
2. ~~**Founder bootstrap**~~ — **done 2026-09-05**: the `roleAssignments` administrator row was created and admin access verified (CAP-007 `grantFounder`). See [docs/FOUNDER-BOOTSTRAP.md](docs/FOUNDER-BOOTSTRAP.md).
