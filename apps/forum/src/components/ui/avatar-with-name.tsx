    ...
    >
      ...
      >
        <Avatar
          className={cn(
            sizeVariants[size],
            "cursor-pointer transition-[transform,colors,box-shadow] duration-normal group-hover/cat:-translate-y-px group-hover/cat:bg-(--bg-overlay) group-hover/cat:shadow-glow-primary-sm",
            avatarClassName,
          )}
          style={avatarStyle}
        >
